...
var Transition = function (props) {
    ...
    return (React.createElement(CSSTransition, __assign({ className: classNames ? classNames : animation }, restProps), wrapper ? React.createElement("div", null, children) : children));
};
