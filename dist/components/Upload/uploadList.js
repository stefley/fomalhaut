...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "fomalhaut-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "fomalhaut-upload-list-item", key: item.uid },
            ...
            React.createElement("span", { className: "file-actoins" },
                React.createElement(Icon, { icon: "times", onClick: function () { var _a; (_a = props.onRemove) === null || _a === void 0 ? void 0 : _a.call(props, item); } })),
